  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-poppins gap-[255px] md:gap-[40px] sm:gap-[40px] items-center justify-end mx-[auto] w-[100%]">
        <div className="h-[1434px] md:h-[666px] sm:h-[946px] relative w-[100%]">
          <div className="absolute bg-gradient  flex flex-col gap-[100px] md:gap-[40px] sm:gap-[40px] h-[max-content] inset-[0] items-center justify-center m-[auto] py-[66px] w-[100%]">
            ...
            <List
              className="flex-col gap-[1px] grid items-center mb-[227px] w-[100%]"
              orientation="vertical"
            >
              <div className="flex flex-1 md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-evenly w-[100%]">
...
export default ListedesoprateursPage;
